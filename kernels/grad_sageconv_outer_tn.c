...
void grad_sageconv_outer_v1(SageLayer *l)   { grad_sageconv_impl(l, outer_tn_v1); }
void grad_sageconv_outer_v2(SageLayer *l)   { grad_sageconv_impl(l, outer_tn_v2); }
void grad_sageconv_outer_v3(SageLayer *l)   { grad_sageconv_impl(l, outer_tn_v3); }
void grad_sageconv_outer_v4(SageLayer *l)   { grad_sageconv_impl(l, outer_tn_v4); }
void grad_sageconv_outer_v5(SageLayer *l)   { grad_sageconv_impl(l, outer_tn_v5); }
